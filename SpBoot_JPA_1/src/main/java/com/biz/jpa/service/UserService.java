...
public class UserService {
	 ...
	 * findById를 실행했을떄 결과 값이 없으면 null을 return한다.
	 * 이런 상황이 되면 NullPointerException이 발생할 수 있다.
	 * 
	 * 이떄 Optional(wrapper class)로 VO 객체를 감싸게 되면 NullPointerException을 회피할 수 있다.
	 * Java 1.8 이상에서 새로 도입된 Wrapper Class 이다.
	 * 
